...
// GenerateKeySymmetricAvatar creates a symmetric avatar and associates it with a key.
func GenerateKeySymmetricAvatar(key string, width, height int) (*KeyAvatar, error) {
